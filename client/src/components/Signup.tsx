      ...
      .catch((err) => {
        errorNotification(
          err.response?.data
            ...
            : "Error signing you up. Please check your network and try again.",
        );
        console.log(err);
      })
      .finally(() => {
    ...
    <Modal dismiss={dismissModal}>
      ...
      >
        ...
        <p className="text-end text-sm mt-2">
          ...
          <span
            className="font-semibold text-orange-500 hover:text-orange-600 cursor-pointer transitionItem"
            onClick={login}
          >
            here
          </span>
